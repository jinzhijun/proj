            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    <li class="menu-list nav-active">
                        <a href=""><i class="fa fa-th-list"></i>  <span>举报管理</span></a>
                        <ul class="child-list">
                            <li><a href=<?php echo site_url('report/index/1')?>> 举报类型列表</a></li>
                            <li class="active"><a href=<?php echo site_url('report/index/2');?>> 举报列表</a></li>
                        </ul>
                    </li>
                </ul>
