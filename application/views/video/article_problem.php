...
<body class="sticky-header sidebar-open">
    ...
    <section>
        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <!--body wrapper start-->
            <div class="wrapper">
                <div class="main-title-list"><span>常见问题列表</span></div>
                    ...
                    <ul>
                        <li>分类：
                            <select id="problem-category">
                                ...
                                <option value="2">咨询客服</option>
                                <option value="3">直播问题</option>
                                <option value="4">账号问题</option>
                            </select>
                        </li>
                        <li>
                            问题：<input type="text" id="problem">
                        </li>
                ...
                <table class="table data-table row-details-data-table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>是</td>
                            <td>29</td>
                            <td><a href="javascript: void(0);" name="problem-state"><span>有效</span></a></td>
                ...
                <div class="cover-content" style="display: none;">
                    ...
                    <form action="">
                        <table class="article-information"> 
                            <tr>
                                <td>分组:</td>
                                <td><select id="problem-category-add">
