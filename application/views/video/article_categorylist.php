...
<body class="sticky-header sidebar-open">
    ...
    <section>
        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <!--body wrapper start-->
            <div class="wrapper">
                <div class="main-title-list"><span>文章分类列表</span></div>
                <table class="table data-table row-details-data-table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>20</td>
                            <td><a href="javascript: void(0);">新闻公告</a></td>
                            <td>新闻公告</td>
                            <td><a href="javascript: void(0);" name="article-state"><span>有效</span></a></td>
                            <td>6</td>
                ...
                <div class="cover-content" style="display: none;">
                    ...
                    <form action="">
                        <table class="article-information"> 
                            <tr>
                                <td>文章名称:</td>
                                <td><input id="article-name" type="text" /></td>
                            </tr>
                            <tr>
                                <td>文章类型:</td>
                                <td><select id="article-type">
                                    <option value="0">普通文章</option>
                                    <option value="1">公告文章</option>
