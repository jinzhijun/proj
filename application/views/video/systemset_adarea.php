            ...
            <!--body wrapper start-->
            <div class="wrapper">
                <div class="main-title-list"><span>广告区域</span></div>
                ...
                <table class="table data-table row-details-data-table" cellspacing="0" width="100%">
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="4"><button class="add-row-btn"type="button">新增</button><button class="remove-btn"type="button">删除</button></th>
                        </tr>
                    </tfoot>
                </table>
                ...
                <div class="cover-content" style="display: none;">
                    ...
                    <form action="">
                        <table class="adarea-add"> 
                            <tr>
                                <td class="item-title">广告区域:</td>
                                <td>
                                    <input type="text">
                                </td>
                            </tr>
